...
import { N as t } from './note.component-I_1O7M8K.js';
import { S as u } from './Stack-CPAJg9KB.js';
...
const f = {
    ...
    content: { control: 'text', description: 'Note content.', table: { type: { summary: 'string' } } },
    href: { control: 'text', description: 'Optional link href.', table: { type: { summary: 'string' } } },
    contentHref: { control: 'text', description: 'Optional link text.', table: { type: { summary: 'string' } } },
  },
  A = {
    title: 'Elements/Composite/Note',
    component: t,
    tags: ['autodocs'],
    args: { type: 'info', content: 'This is an info note.' },
  ...
  n = {
    render: (o) =>
      e.jsxs(u, {
        ...
        sx: { maxWidth: 520 },
        children: [
          e.jsx(t, { ...o, type: 'info', content: 'Info message.' }),
          e.jsx(t, { ...o, type: 'recommend', content: 'Recommendation message.' }),
          e.jsx(t, { ...o, type: 'warning', content: 'Warning message.' }),
          e.jsx(t, { ...o, type: 'error', content: 'Error message.' }),
        ],
      }),
  },
  s = {
    args: { type: 'warning', content: 'Please read', contentHref: 'the documentation', href: 'https://example.com' },
  };
var a, m, p;
r.parameters = {
  ...r.parameters,
...
n.parameters = {
  ...
  render: args => <Stack spacing={2} sx={{
    maxWidth: 520
      ...
      ...((d = (c = n.parameters) == null ? void 0 : c.docs) == null ? void 0 : d.source),
    },
  },
};
var g, l, y;
s.parameters = {
  ...
  args: {
    ...
    href: 'https://example.com'
      ...
      ...((y = (l = s.parameters) == null ? void 0 : l.docs) == null ? void 0 : y.source),
    },
  },
};
const V = ['Default', 'Types', 'WithLink'];
export { r as Default, n as Types, s as WithLink, V as __namedExportsOrder, A as default };
