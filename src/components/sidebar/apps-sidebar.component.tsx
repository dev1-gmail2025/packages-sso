  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ gap: PADDING_GAP_ITEM, display: 'flex', flexDirection: 'column' }}>
          <Typography variant="subtitle2">Workflow Engine</Typography>
          <AppGrid
            apps={allApps.filter((app) => app.category === AppCategory.WORKFLOW)}
            columns={4}
            iconSize={60}
            iconRadius={5.5}
            gap={PADDING_GAP_ITEM}
        ...
        <Box sx={{ gap: PADDING_GAP_ITEM, display: 'flex', flexDirection: 'column' }}>
          ...
          <AppGrid
            apps={allApps.filter((app) => app.category === AppCategory.PLATFORM_INFO)}
            columns={4}
            iconSize={60}
            iconRadius={5.5}
            gap={PADDING_GAP_ITEM}
