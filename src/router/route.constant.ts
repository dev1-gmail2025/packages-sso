...
export const ALLOW_USER_TYPES = [UserType.ADMIN, UserType.HR, UserType.User, UserType.C_B, UserType.ROOT];
export const PAGE: Record<string, RouteConstant> = {
  ...
  TEST_COMPONENT: { path: '/test-component', type: RouteType.PUBLIC, allowUserTypes: [] },
