...
import iconEHiring from '../../assets/icon/icon-e-hiring.svg';
import iconForm from '../../assets/icon/icon-form.svg';
import iconHR from '../../assets/icon/icon-hr.svg';
...
import logoSub2 from '../../assets/logo/logo-sub-2.svg';
import logoSub3 from '../../assets/logo/logo-sub-3.svg';
import logoSub4 from '../../assets/logo/logo-sub-4.svg';
import logoSub5 from '../../assets/logo/logo-sub-5.svg';
